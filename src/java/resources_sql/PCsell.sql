...
create table computadora(
	...
	constraint fk_computador_tm foreign key(tarjetamadre) references tarjeta_madre(id) on delete cascade on update cascade,
	constraint fk_computador_ram foreign key(memoriaram) references memoria_ram(id) on delete cascade on update cascade,
